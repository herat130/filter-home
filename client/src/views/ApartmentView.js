...
export class ApartmentView extends React.Component {
  ...
  render() {
    ...
    const email = (apartment.owner || {}).email || '';
    return (
              ...
              <div className="view-apartment-item-content">
                <div className="_3im4pDXrDfzNRT2AlvLfD6">
                  <div className="listing-image">
                    <div className="media-cover" style={{ backgroundImage: `url(${image})`, backgroundPosition: 'center', backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}></div>
                  ...
                  <div className="listing-details-container">
                    <div className="listing-details">
                      ...
                      <div className="_17om8IEGFeu2W2TBOJ6xQs Lsdn2hC-tehVod76x4HzK text-truncate">
                        <span className={classnames({ hidden: email.length === 0 })}><a href={`mailto:${email}??Subject=Apartment%20Enquiry`} target="_top">{email}</a></span>
                      </div>
                      <div className="_17om8IEGFeu2W2TBOJ6xQs Lsdn2hC-tehVod76x4HzK text-truncate" >
                        <Link to={`/${apartment.location._id}`}>{apartment.location.title}</Link>
                      </div>
